    ...
    function stateConfig($stateProvider) {
        ...
        .state('project', {
            ...
            data: {
                ...
                pageTitle: 'stageCapServiceApp.project.home.title'
            },
            views: {
                'content@': {
        ...
        .state('project-detail', {
            ...
            data: {
                authorities: ['ROLE_USER'],
                pageTitle: 'stageCapServiceApp.project.detail.title'
            },
            views: {
                'content@': {
            ...
            onEnter: function($stateParams, ProjectTimestampService) {
                ProjectTimestampService.subscribe($stateParams.id);
            },
            onExit: function($stateParams, ProjectTimestampService) {
                ProjectTimestampService.unsubscribe($stateParams.id);
            }
        })
        .state('project.new', {
            parent: 'project',
